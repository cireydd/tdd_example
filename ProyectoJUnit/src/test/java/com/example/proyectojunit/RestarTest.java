...
public class RestarTest {
    ...
    @Test
    public void puedoRestar2y2() throws Exception {
    ...
    @Test
    public void puedoRestarmenos40y5(){
        assertThrowsExactly(Exception.class, () -> {
            //Calculadora calc = new Calculadora();
            int res = calc.restar(-40,5);
            assertEquals(-45, res);
    ...
    @Test
    public void laRestaNoTardaMasDe1s(){
